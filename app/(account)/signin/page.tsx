        ...
        <main  className="h-full">
            <div className="sm:flex items-center justify-center h-full">
                <div className="m-2 mt-5 md:mx-auto md:my-0 lg:mx-16">
                    <Image src="/images/gmbr_login_signup.png" alt="gambar" className="md:w-[400px] md:h-[400px] object-cover mx-6" width={350} height={350}/>
                </div>
                <div className="flex-shrink-0 mx-2.5 md:mx-auto lg:mx-16">
                    <div className=" w-[320px] md:w-[384px]  bg-white px-5 py-3 shadow-md rounded-xl m-2 border border-solid border-sky-600 mx-6">
                        ...
                        <div className="mt-5">
                            <button className="py-1 pl-3 w-full text-center bg-gradient-to-r from-[#274B74] to-[#8233C5] rounded-full font-bold text-white">LOGIN</button>
                        </div>
